...
# Create base icon with emoji
convert -size 1024x1024 xc:none -fill "#2196F3" -draw "roundrectangle 0,0 1024,1024 100,100" \
  -pointsize 600 -fill white -gravity center -font "AppleColorEmoji" -annotate 0 "🙋‍♀️" "$ICON_DIR/icon-1024.png"
...
echo "App icons created in $ICON_DIR"